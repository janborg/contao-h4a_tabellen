...
class H4aTabelleElement extends AbstractContentElementController
{
    ...
    protected function getResponse(Template $template, ContentModel $model, Request $request): Response
    {
        if ($this->scopeMatcher->isBackendRequest($request)) {
            ...
            $template->wildcard = 'H4a Tabelle (Liga-ID: '.$model->h4a_liga_ID.')';
        ...
        return $template->getResponse()->setSharedMaxAge(System::getContainer()->getParameter('janborg_h4a_tabellen.TabellenCacheTime'));
    }
}
